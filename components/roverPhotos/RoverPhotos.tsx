        ...
        {marsRover.photos &&
          marsRover.photos.map((photo) => (
            <div key={photo.id} className={styles.roverCard}>
              ...
              <p>
                <b>Rover Id:</b> {photo.id}
              </p>
              <p>
                <b>Landing date:</b> {photo.rover.landing_date}
              </p>
              <p>
                <b>Launch date:</b> {photo.rover.launch_date}
              </p>
              <p>
                <b>Rover Name:</b> {photo.rover.name}
              </p>
              <p>
                <b>Status:</b> {photo.rover.status}
              </p>
            </div>
          ))}
      </div>
